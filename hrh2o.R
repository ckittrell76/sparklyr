...
usePackage("tidyquant")  # Loads tidyverse and several other pkgs   
usePackage("readxl")     # Super simple excel reader
usePackage("h2o")        # Professional grade ML pkg
usePackage("lime")       # Explain complex black-box ML models
usePackage("RCurl")      # get the data
usePackage("readxl")

# get data from here
url <- "https://community.watsonanalytics.com/wp-content/uploads/2015/03/WA_Fn-UseC_-HR-Employee-Attrition.xlsx"
destfile <- "WA_Fn_UseC_HR_Employee_Attrition.xlsx"
curl::curl_download(url, destfile)
hr_data_raw <- read_excel(destfile)
